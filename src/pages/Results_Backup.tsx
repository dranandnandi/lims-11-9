...
type ViewMode = 'entry' | 'review' | 'verification';
...
const Results: React.FC = () => {
  ...
  const [orderTestProgress, setOrderTestProgress] = useState<OrderTestProgress[]>([]);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Result Entry & Management Hub</h1>
          <p className="text-gray-600 mt-1">Comprehensive result entry, review, and verification workflow</p>
        </div>
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="flex items-center bg-gray-100 rounded-lg p-1">
            <button
              ...
              className={`px-4 py-2 rounded-md transition-colors ${
                viewMode === 'entry' ? 'bg-white shadow-sm text-gray-900' : 'text-gray-600 hover:text-gray-900'
              }`}
            >
              Entry
            </button>
            <button
              ...
              className={`px-3 py-2 rounded-md text-sm font-medium transition-colors ${
                viewMode === 'review' ? 'bg-white text-gray-900 shadow-sm' : 'text-gray-600 hover:text-gray-900'
              }`}
            >
              Review
            </button>
          ...
          {viewMode === 'entry' && (
            <div className="flex items-center space-x-2 border-l pl-4">
              ...
              <select
                value={entryViewMode}
                onChange={(e) => setEntryViewMode(e.target.value as EntryViewMode)}
                className="px-3 py-1 border rounded-md text-sm focus:ring-2 focus:ring-blue-500"
              >
                <option value="order-based">Order</option>
      ...
      {/* Entry Mode Render Function */}
      {/* This function is defined below the main component but used above */}
      {/* Loading Overlay */}
      {loading && (
